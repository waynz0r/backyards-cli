...
var Chart = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 8, 6, 17, 5, 52, 0, time.UTC),
		},
		...
		"/Chart.yaml": &vfsgen۰CompressedFileInfo{
			name:             "Chart.yaml",
			modTime:          time.Date(2019, 8, 6, 17, 5, 40, 0, time.UTC),
			uncompressedSize: 105,

			compressedContent: []byte(""),
		},
		"/templates": &vfsgen۰DirInfo{
			name:    "templates",
			modTime: time.Date(2019, 8, 5, 11, 59, 5, 0, time.UTC),
		},
		"/templates/_helpers.tpl": &vfsgen۰CompressedFileInfo{
			name:             "_helpers.tpl",
			modTime:          time.Date(2019, 8, 6, 17, 13, 49, 0, time.UTC),
		...
		"/templates/analytics-v1.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 6, 17, 11, 27, 0, time.UTC),
		...
		"/templates/bookings-v1.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 6, 17, 11, 44, 0, time.UTC),
		...
		"/templates/catalog-v1.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 6, 17, 11, 56, 0, time.UTC),
		...
		"/templates/frontpage-v1.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 6, 17, 12, 5, 0, time.UTC),
		...
		"/templates/istio.yaml": &vfsgen۰CompressedFileInfo{
			name:             "istio.yaml",
			modTime:          time.Date(2019, 8, 5, 0, 9, 27, 0, time.UTC),
		...
		"/templates/movies-v1.yaml": &vfsgen۰CompressedFileInfo{
			name:             "movies-v1.yaml",
			modTime:          time.Date(2019, 8, 6, 17, 12, 15, 0, time.UTC),
		...
		"/templates/movies-v2.yaml": &vfsgen۰CompressedFileInfo{
			name:             "movies-v2.yaml",
			modTime:          time.Date(2019, 8, 6, 17, 11, 20, 0, time.UTC),
		...
		"/templates/movies-v3.yaml": &vfsgen۰CompressedFileInfo{
			name:             "movies-v3.yaml",
			modTime:          time.Date(2019, 8, 6, 17, 12, 27, 0, time.UTC),
			uncompressedSize: 790,
		...
		"/templates/namespace.yaml": &vfsgen۰CompressedFileInfo{
			name:             "namespace.yaml",
			modTime:          time.Date(2019, 8, 6, 17, 30, 59, 76239000, time.UTC),
		...
		"/templates/notifications-v1.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 6, 17, 14, 29, 0, time.UTC),
		...
		"/templates/payments-v1.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 6, 17, 14, 36, 0, time.UTC),
		...
		"/templates/services.yaml": &vfsgen۰CompressedFileInfo{
			name:             "services.yaml",
			modTime:          time.Date(2019, 8, 6, 17, 7, 18, 0, time.UTC),
		...
		"/values.yaml": &vfsgen۰CompressedFileInfo{
			name:             "values.yaml",
			modTime:          time.Date(2019, 8, 6, 17, 10, 6, 0, time.UTC),
